...
run: install 
	...
	# 1D without history:
	$(GNUPLOT) -e "set style data lines; set output 'black_hole.png'; plot 'black_hole.txt' using 2:18"
	# 1D with history:
	#$(GNUPLOT) -e "set style data lines; set output 'black_hole.png'; splot 'black_hole.txt' using 1:2:18"
